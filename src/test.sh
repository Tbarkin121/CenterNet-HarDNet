...
# python test_mod.py ctdet_mod --exp_id coco_h68 --arch hardnet_68 --dataset coco_mod --not_prefetch_test --load_model ../models/centernet_hardnet68_coco_mod_1epochs_3cat.pth
# python test.py ctdet --exp_id coco_h85 --arch hardnet_85 --load_model ../models/centernet_hardnet85_coco.pth

# Images Test
python demo.py ctdet_mod --demo ../images --arch hardnet_68 --load_model ../models/centernet_hardnet68_coco_mod_2epochs_3cat.pth
