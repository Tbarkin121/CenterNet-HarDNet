...
python main_mod.py ctdet_mod --exp_id coco_h68 --arch hardnet_68 --dataset coco_mod --batch_size 6 --lr 1e-2 --gpus 0 --num_workers 4 --num_epochs 2 --lr_step 230,280 --resume --load_model ../models/centernet_hardnet68_coco_mod_1epochs.pth
